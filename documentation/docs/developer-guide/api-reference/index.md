...
- **Endpoint**: `POST /api/2.0.0/public`
...
```json
{
    "uri": "http://localhost:3333/api/2.0.0/documents/2ad789c7-e513-4523-a826-ab59e1c423cd.json",
...
- **Endpoint**: `POST /api/2.0.0/private`
- **Authentication**: Required (`X-API-Key` header)
- **Content Types**: `application/json` or `multipart/form-data`
...
```json
{
    "uri": "http://localhost:3333/api/2.0.0/documents/e8b32169-582c-421a-a03f-5d1a7ac62d51.json",
    "hash": "d6bb7b579925baa4fe1cec41152b6577003e6a9fde6850321e36ad4ac9b3f30a",
