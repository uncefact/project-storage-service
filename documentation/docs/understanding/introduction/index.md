...
- To understand how public and private storage work, read [How It Works](../how-it-works).
- To start integrating with the API, see the [Developer Guide](../../developer-guide/api-reference).
- To deploy the service, see the [Deployment Guide](../../deployment-guide/installation).
